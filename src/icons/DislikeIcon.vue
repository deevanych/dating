<template>
  <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M20.4326 17.0816L13.8466 10.4994L20.4276 3.91331C21.1866
    ...
    17.9339 20.7995 17.446 20.4352 17.0816H20.4326Z"
          fill="url(#paint1_linear)"/>
    <defs>
      <linearGradient id="paint1_linear" x1="3.7575" y1="-1.6533" x2="17.8857" y2="20.1402"
                      gradientUnits="userSpaceOnUse">
        <stop offset="0" stop-color="var(--v-pink-base)"/>
        <stop offset="1" stop-color="var(--v-red-base)"/>
      </linearGradient>
    </defs>
  </svg>
</template>
...
@Component
export default class DislikeIcon extends Vue {
